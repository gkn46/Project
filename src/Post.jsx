...
const Post = ({ post, onLike, onComment }) => {
  ...
  const handleUpdate = (commentId) => {
    ...
    const updatedText = prompt('Yorumu güncelle:', comments.find(comment => comment.id === commentId).text);
    if (updatedText !== null) {
  ...
  const handleDelete = (commentId) => {
    ...
    const shouldDelete = window.confirm('Bu yorumu silmek istediğinizden emin misiniz?');
    if (shouldDelete) {
